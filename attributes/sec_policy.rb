...
# xccdf_org.cisecurity.benchmarks_rule_2.2.3_L1_Configure_Access_this_computer_from_the_network:
...
# xccdf_org.cisecurity.benchmarks_rule_2.2.4_L1_Ensure_Act_as_part_of_the_operating_system_is_set_to_None:
...
# xccdf_org.cisecurity.benchmarks_rule_2.2.9_L1_Configure_Allow_log_on_through_Remote_Desktop_Services_Administrators:
...
# xccdf_org.cisecurity.benchmarks_rule_2.2.18_L1_Configure_Create_symbolic_links:
default['security_policy']['rights']['Create symbolic links'] = {
  'CIS_Control' => 'SeCreateSymbolicLinkPrivilege = *S-1-5-32-544',
}

# xccdf_org.cisecurity.benchmarks_rule_2.2.21_L1_Configure_Deny_access_to_this_computer_from_the_network:
default['security_policy']['rights']['Deny access to this computer from the network'] = {
  'CIS_Control' => 'SeDenyNetworkLogonRight = *S-1-5-32-546,*S-1-5-114',
}
...
# xccdf_org.cisecurity.benchmarks_rule_2.2.28_L1_Configure_Enable_computer_and_user_accounts_to_be_trusted_for_delegation:
...
# xccdf_org.cisecurity.benchmarks_rule_2.2.32_L1_Configure_Impersonate_a_client_after_authentication:
...
# xccdf_org.cisecurity.benchmarks_rule_2.2.38_L1_Ensure_Manage_auditing
...
# xccdf_org.cisecurity.benchmarks_rule_2.2.43_L1_Ensure_Profile_system_performance_is_set_to_Administrators_NT_SERVICEWdiServiceHost_:
...
# xccdf_org.cisecurity.benchmarks_rule_2.2.44_L1_Ensure_Replace_a_process_level_token_is_set_to_LOCAL_SERVICE_NETWORK_SERVICE_:
